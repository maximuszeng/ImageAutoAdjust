...
public class ImageRotator {
	...
	/**
	 * Rotate the image according to the input angel.
	 * 
	 * @param src  source buffered image.
	 * @param angel  rotate angel.
	 * @return buffered image been rotated.
	 */
	...
	public static Rectangle calcRotatedSize(Rectangle src, int angel) {
		...
		// double angel_dalta_width = Math.atan((double) src.height /
		// src.width);
		// double angel_dalta_height = Math.atan((double) src.width /
		// src.height);
		...
		int des_width = src.width;
		int des_height = src.height;
